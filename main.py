...
bot = Client("bot",    
   bot_token="7929130193:AAFJswIMtSV_CPazyAPKW4BQ58ijov3t-5I",    
   api_id= 28094744,    
...
async def account_login(bot: Client, m: Message):    
    ...
    await editable.edit("-═════━‧₊˚❀༉‧₊˚.━═════-\nɴᴏᴡ ꜱᴇɴᴅ ᴛʜᴇ **ᴛʜᴜᴍʙ ᴜʀʟ eg: https://tinypic.host/images/2025/01/21/Purvi-Cid.jpg**\n ᴏʀ ꜱᴇɴᴅ [`no`]\n-═════━‧₊˚❀༉‧₊˚.━═════-")    
    ...
    try:    
        for i in range(count - 1, len(links)):
            ...
            try:
                ...
                cc = f'**[ 🎞️ ] 𝗩𝗜𝗗 𝗜𝗗 : {str(count).zfill(3)}**\n**𝐕𝐢𝐝𝐞𝐨 𝐓𝐢𝐭𝐥𝐞** : {name1}**({res})  🥀🅽🅸🅺🅷🅸🅻🦅**.mp4\n\n**𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** : **{b_name}**\n\n**𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 ➤ {MR}**\n\n'    
